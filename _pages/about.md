...
- **Implicit Modality-Reduction (IMR) bottleneck** in existing modality missing prompt tuning, and a new metric **Normalized Missing-modality Mutual Information (NM2I)** quantifies IMR.
