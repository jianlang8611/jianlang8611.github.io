...
My research focuses on <strong>Robust & Personalized Multimodal Intelligence</strong> in <strong>real-world</strong>, <strong>non-ideal</strong>, and <strong>dynamic</strong> conditions. I am enthusiastic about designing multimodal systems that can perform effectively under <strong>(1) imperfect inputs and environments</strong> (e.g., modality missing, distribution shifts) and <strong>(2) user-specific dynamics</strong> (e.g., MLLM personalization). I am also interested in <strong>multimodal video understanding and detection</strong>, where I am dedicated to improving the generalization and robustness of detection models in real-world scenarios.
